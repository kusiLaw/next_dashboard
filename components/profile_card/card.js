...
const ProfileCard = () => {
  return (
   <div className='flex gap-6 absolute bg-green p-4 top-14 right-0 bg-white shadow-xl  z-10'>
     ...
     <button  className='flex gap-2 items-center text-gray-500 self-end mt-2  hover:text-black transition-all duration-500'>
